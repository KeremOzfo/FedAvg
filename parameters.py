...
def args_parser():
    ...
    # Federated params
    parser.add_argument('--alg', type=int, default=1, help='alg type')
    parser.add_argument('--alfa', type=float, default=1, help='weigths ')
    parser.add_argument('--beta', type=float, default=0, help='weigths ')
    parser.add_argument('--alfaList', type=list, default=[1, 0.95, 0], help='weigths ')
    parser.add_argument('--betaList', type=list, default=[0, 0.05, 1], help='weigths ')
    parser.add_argument('--H_List', type=list, default=[8, 8, 1], help='set to local Iter ')
    ...
    parser.add_argument('--alfa_change', type=list, default=[150, 160, 250],
